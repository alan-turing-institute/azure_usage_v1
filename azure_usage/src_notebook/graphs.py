...
def plot_year_month_bar_stacked_ext(spnsr_df, ea_df, ylim=None):
    ...
    Args:
        spnsr_raw_data_gr_df: a dataframe with two columns: Year-Month
            and Cost representing raw expenditure for the sponsorhip account

        ea_raw_data_gr_df: a dataframe with two columns: Year-Month and Cost
            representing raw expenditure for the ea accounts
    """
